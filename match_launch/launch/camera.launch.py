...
def generate_launch_description():
    ...
    bridges = [
        '/world/default/model/match_drohne_fr_camera_0/link/front_camera_link/sensor/front_camera/image@sensor_msgs/msg/Image[gz.msgs.Image',
        '/world/default/model/match_drohne_fr_camera_0/link/front_camera_link/sensor/front_camera/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo'
    ]
    ...
    return LaunchDescription([
        ...
        TimerAction(
            ...
            actions=[
                ...
                shell=True,
                additional_env={
                    "PX4_SYS_AUTOSTART": "40013",
                    "PX4_SIM_MODEL": "match_drohne_fr_camera",
