...
def generate_launch_description():
    ...
    rgbd_sync = Node(
        ...
        remappings=[
            ("rgb/image",       "/marvin_drohne_alles/front_rgb/image"),
            ("rgb/camera_info", "/marvin_drohne_alles/front_rgb/camera_info"),
            ("depth/image",     "/marvin_drohne_alles/front_depth/image"),
            ("depth/camera_info", "/marvin_drohne_alles/front_depth/camera_info"),
