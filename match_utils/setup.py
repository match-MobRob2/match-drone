...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'imu_propagation = match_utils.imu_propagation:main',
            'light_controller = match_utils.light_controller:main',
            'light_watchdog = match_utils.light_watchdog:main',
            'recorder = match_utils.recorder:main',
        ],
    },
)
