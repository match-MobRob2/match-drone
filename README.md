...
* **QGroundControl** 
* **teleop_twist_keyboard** package: Teleoperation ROS interface. For reference, see the [TELEOP](https://github.com/match-MobRob2/match-drone/wiki/teleoperation.md) WIKI documentation.
...
3. Run fast-lio2 package using custom YAML params file to start mapping (in new terminal)
   ...
   ```
      - See the documentation for [FAST-LIO2 custom params](https://github.com/match-MobRob2/match-drone/wiki/fast-lio2-params.md) under the repo's WIKI.
...
6. To save recorded map manually (in new terminal)
   ...
   ```
      - To see the documentation on [saving recorded map](https://github.com/match-MobRob2/match-drone/wiki/fast-lio2-params.md), please refer to the corresponding section in the repo's WIKI.
