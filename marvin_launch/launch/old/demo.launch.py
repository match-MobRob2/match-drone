    ...
    return LaunchDescription([
        ...
        TimerAction(
            ...
            ExecuteProcess(
                ...
                f"source {px4_dir}/Tools/simulation/gazebo-classic/setup_gazebo.bash {px4_dir} {px4_dir}/build/px4_sitl_default && "
                f"gz model --verbose "
                f"--spawn-file $(ros2 pkg prefix marvin_models)/share/marvin_models/urdf/iris.sdf "
                "--model-name marvin_drohne -x 1.01 -y 0.98 -z 0.83"
                ],
                output="screen"
            )
            ]
