...
def generate_launch_description():
    ...
    declare_args = [
        ...
        DeclareLaunchArgument("spawn_x", default_value="1.5", description="Spawn X."),
        DeclareLaunchArgument("spawn_y", default_value="1.5", description="Spawn Y."),
    ...
    px4_process = ExecuteProcess(
        ...
        additional_env={
            ...
            "PX4_GZ_MODEL_POSE": [
                ...
                TextSubstitution(text=","),
                spawn_z,
                TextSubstitution(text=",0,0,1.57"),
            ],
            "PX4_GZ_STANDALONE": "1",
            "PX4_GZ_WORLD": world,
