...
def generate_launch_description():
    ...
    bridges = [
        '/world/empty/model/match_drohne_fr_camera_0/link/front_camera_link/sensor/front_camera/image@sensor_msgs/msg/Image[gz.msgs.Image',
        '/world/empty/model/match_drohne_fr_camera_0/link/front_camera_link/sensor/front_camera/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo'
    ]
