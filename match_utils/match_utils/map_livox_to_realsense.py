...
class LidarCameraFusion(Node):
    def __init__(self):
        ...
        self.declare_parameter('image_topic', '/match_drohne_alles/front_rgb/image')
        self.declare_parameter('camera_info_topic', '/match_drohne_alles/front_rgb/camera_info')
